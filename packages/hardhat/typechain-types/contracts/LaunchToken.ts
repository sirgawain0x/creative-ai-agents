...
export interface LaunchTokenInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "fid", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "fid", data: BytesLike): Result;
...
export interface LaunchToken extends BaseContract {
  ...
  fid: TypedContractMethod<[], [bigint], "view">;
  ...
  socialProof: TypedContractMethod<[], [string], "view">;
